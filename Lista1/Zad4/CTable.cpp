...
CTable::CTable(const CTable &pcOther) { /*ampesand bo przesylam referencje (operuje bezposrednio na obiekcie) a nie kopie*/
...
void CTable::vFillTable(int fill_number){
    for (int i = 0; i < i_table_length; i++)
    {
        pi_table[i] = fill_number + i;
    }
    cout << endl;
}
