...
int main() {
    ...
    // string expression2 = "+ * 5 sin x * + a b 8";
    ...
    // cout << "Evaluating Tree 1 with a=3, b=4, c=5:\n";
    // tree1.comp(values1);
    // vector<int> values2;
    // cout << "Evaluating Tree 2 with a=2, b=4, x=90:\n";
    ...
    //
    // vector<int> values3;
    // cout << "Evaluating Tree Adding with a=2, b=3, c=4:\n";
